...
if sys.platform == "win32":
    PORT = "COM5"  # Change to COM5 or COM7 depending on which receiver
else:
    PORT = "/dev/cu.usbserial-210"  # Mac port

BAUD = 115200
OUT_CSV = os.path.join(os.path.dirname(__file__), "rx_C.csv")
    ...
    while True:
        try:
            ...
            if m:
                ...
                f.flush()
                print(f"RX_C: {t:.3f}s  RSSI={rssi} dBm  SNR={snr} dB")
