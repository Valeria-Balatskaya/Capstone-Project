#!/usr/bin/env python3
"""
Windows Receiver B - Sends data to Mac Server
==============================================
Runs on Windows laptop #1 with receiver board connected.
- Reads LoRa data from local receiver
- Sends data to Mac server via WebSocket

Setup:
    1. Connect receiver board to Windows USB
    2. Check Device Manager for COM port (e.g., COM5)
    3. Run: python windows_receiver_B.py --port COM5 --server ws://MAC_IP:8765/data
"""
